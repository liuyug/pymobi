...
class BookMobi(object):
    ...
    palmdoc_format = [
        ...
        ('encryptionType',  '>H',  12),
        ('type1KeyData',    '16s', 14),   # if no mobi data
    ]
    compression_type = {
    ...
    def __init__(self, filename):
        ...
        self.f = f = open(self.filename, 'rb')
        ...
        if ident == self.pd_file_code['PalmDOC']:
            ...
            if (
                ...
                while count < exthCount:
                    ...
                    if DEBUG:
                        if not recordType in self.mobi_exth_type:
